{block name='productdetails-availability-notification-form'}
	<div class="panel-wrap">
		{block name='availability-form-popup-alerts'}
		...
		{block name='availability-form'}
			<form action="{if !empty($Artikel->cURLFull)}{$Artikel->cURLFull}{else}{$ShopURL}/{/if}" method="post" id="article_availability{$Artikel->kArtikel}" class="jtl-validate">
				...
				<fieldset>
					{block name='availability-form-firstname-lastname'}
						{if $Einstellungen.$tplscope.benachrichtigung_abfragen_vorname !== 'N' || $Einstellungen.$tplscope.benachrichtigung_abfragen_nachname !== 'N'}
							{block name='availability-form-firstname'}
								...
								{/if}
							{/block}
							{block name='availability-form-lastname'}
						...
						{/if}
					{/block}
					{block name='availability-form-email'}
					...
					{/block}
					{block name='availability-form-checkbox'}
				...
				{block name='availability-form-captcha'}
				...
				{/block}
				{block name='availability-form-submit'}
