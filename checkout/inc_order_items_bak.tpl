        ...
        <div class="type-{$oPosition->nPosTyp} c-it{if isset($isSidebar)} sb-it{/if}{if isset($isCheckout)} sb-it{/if}">
            <div class="row">
                {* if $Einstellungen.kaufabwicklung.warenkorb_produktbilder_anzeigen === 'Y' *}
                    <div class="img-col col-3 col-md-2 col-xl-1">
                ...
                <div class="col-9 col-md-10 col-xl-11">
                    <div class="row first">
                        <div class="col-9 col-lg-9">
                             {if $oPosition->nPosTyp == $C_WARENKORBPOS_TYP_ARTIKEL || $oPosition->nPosTyp == $C_WARENKORBPOS_TYP_GRATISGESCHENK}
                                <a href="{$oPosition->Artikel->cURLFull}" title="{$oPosition->cName|trans}"><strong>{$oPosition->cName|trans}</strong></a>
                                {if !isset($isSidebar)}
                    ...
                    <div class="row">
                        {if $tplscope === 'cart'}
                        <div class="col-9 col-lg-9 small">
                        ...
                        {/if}
                        <div class="{if $tplscope === 'cart'}col-3 col-lg-3{else}col-12 col-lg-12{/if} text-right">
                            <strong class="price">
                                {if $oPosition->istKonfigVater()}
